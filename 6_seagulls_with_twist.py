...
async def main():
    ...
    task_1 = asyncio.create_task(assign_seagull_with_task("Blocky","Just go around and block stuff.",True))
    task_2 = asyncio.create_task(assign_seagull_with_task("Ozzy","Scream and wake up the neighbourhood.",False))
